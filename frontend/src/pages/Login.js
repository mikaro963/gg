  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      ...
      <div className="max-w-md w-full bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800 shadow-2xl">
        <img src="/logo.png" alt="Cash Wallet Logo" className="h-20 w-auto mx-auto mb-6" />
        <h2 className="text-3xl font-bold text-white text-center mb-8">{t('login')}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-gray-300 mb-2 font-semibold">{t('email')}</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-gray-300 mb-2 font-semibold">{t('password')}</label>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all duration-200 font-semibold shadow-lg disabled:opacity-50"
          >
