            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-4 bg-[#0a0a0a] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all disabled:opacity-50"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        disabled={emailVerified}
                        className="w-full px-4 py-4 pr-14 bg-[#0a0a0a] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all disabled:opacity-50"
                  ...
                  {!emailVerified && !otpSent && (
                    <button
                      ...
                      className="w-full py-4 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all font-semibold disabled:opacity-50"
                    >
                      {loading ? (i18n.language === 'ar' ? 'جاري الإرسال...' : 'Sending...') : (i18n.language === 'ar' ? 'إرسال رمز التحقق' : 'Send Verification Code')}
                    </button>
                  )}
              ...
              {step === 3 && (
                <motion.div
                  ...
                  className="space-y-6"
                >
                  <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/50 rounded-xl">
                    <p className="text-emerald-300 text-sm text-center">
                      {i18n.language === 'ar' 
                        ? 'تم التحقق من حسابك بنجاح! الآن يمكنك تسجيل الدخول.'
