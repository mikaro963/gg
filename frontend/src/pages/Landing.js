      ...
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="px-6 py-2 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-all duration-200 font-semibold backdrop-blur-sm border border-gray-800"
          >
            {t('login')}
          </button>
        </div>
      ...
      <div className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <button
            ...
            className="px-8 py-4 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all duration-200 text-lg font-semibold shadow-2xl transform hover:scale-105"
          >
            {t('getStarted')}
          </button>
        </div>
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800">
            ...
            <p className="text-gray-400 text-center">End-to-end encryption and secure transactions</p>
          </div>
          ...
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800">
            ...
            <p className="text-gray-400 text-center">Support for USD, USDT, SYP, and TRY</p>
          </div>
          ...
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800">
            ...
            <p className="text-gray-400 text-center">Instant currency exchange with best rates</p>
          </div>
        </div>
      </div>
